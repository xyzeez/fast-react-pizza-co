...
const CreateOrder = () => {
  ...
  const isFetchAddress = status === 'loading';
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <div className="absolute right-[3px] top-[3px] md:right-[5px] md:top-[5px] z-50">
              <Button
                type="small"
                disabled={isFetchAddress}
                clickHandler={(e) => {
        ...
        <div>
          ...
          <Button disabled={isSubmitting || isFetchAddress} type="primary">
            {isSubmitting
              ? 'Placing order....'
